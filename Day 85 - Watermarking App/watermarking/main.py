...
# file upload button
upload_button = Button(edit_frame, text="Upload Image", command=file_open, style="Wide.TButton")
...
# watermark color
text_color = (0, 0, 0)
color_selection = Canvas(edit_frame, bg=rgb_to_hex(text_color), width=110, height=15)
color_selection.grid(column=0, row=5)

color_button = Button(edit_frame, text="Change Color", command=change_text_color, style="Color.TButton", width=18)
...
# save Button
save_button = Button(edit_frame, text="Save", command=save_new_image, style="Wide.TButton")
